...
Source0  : https://files.pythonhosted.org/packages/23/97/b6f296d1e9cc1ec25c7604178b48532fa5901f721bcf1b8d8148b13e5588/yapf-0.43.0.tar.gz
...
%prep
%setup -q -n yapf-0.43.0
cd %{_builddir}/yapf-0.43.0
pushd ..
cp -a yapf-0.43.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731596585
